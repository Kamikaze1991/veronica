...
class telefonocliente implements IModelo
{


	//definicion de datos
	const TABLE_NAME="telefonocliente";
	const ALL_FIELDS="ID,IDCLIENTE,TELEFONO,DESCRIPCION";
	...
	private function crear($_array_data)
	{
		...
		try{
			...
			if($_array_data)
			{
				...
				$_rs=conexion::getInstancia()->GenericQueryProcedure("call INGRESO_TELEFONO(?,?,?)",$_array_data);	
