...
class transporte implements IModelo
{


	//definicion de datos
	const TABLE_NAME="transporte";
	const ALL_FIELDS="ID,CODIGO,DESCRIPCION,MATRICULA,TIPO";
	...
	private function crear($_array_data)
	{
		...
		try{
			...
			if($_array_data)
			{
				...
				$_rs=conexion::getInstancia()->GenericQueryProcedure("call INGRESO_TRANSPORTE(?,?,?,?)",$_array_data);	
